...
variable "deploy_qdrant" {
  type        = bool
  default     = true
  description = "Controls the deployment of the qdrant helm chart."
}

variable "qdrant_user_values_override" {
  type        = string
  default     = ""
  description = "User provided values to override the Qdrant helm chart defaults and those generated by Terraform using the templates."
}
...
variable "deploy_vllm" {
  type        = bool
  default     = true
  description = "Controls the deployment of the vLLM helm chart."
}

variable "vllm_user_values_override" {
  type        = string
  default     = ""
  description = "User provided values to override the vLLM helm chart defaults and those generated by Terraform using the templates."
}
...
variable "HF_TOKEN" {
  type        = string
  description = "Hugging Face token. The token is required for vLLM to be able to pull the model from HuggingFace."
}

variable "LLM_API_KEY" {
  type        = string
  description = "API KEY used to secure your vLLM deployment."
}

variable "model" {
  type        = string
  default     = "meta-llama/Meta-Llama-3-8B-Instruct"
  description = "Name of the LLM to fetch from HuggingFace."
}
